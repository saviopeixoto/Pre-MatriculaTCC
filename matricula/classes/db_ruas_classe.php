...
//   var $j14_vlrm2t = 0;
   ...
   var $campos = "
                 ...
                 j14_vlrm2t = float8 = Valor M2 Terreno
                 ";
...
//     $this->rotulo = new rotulo("ruas");
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->j14_vlrm2t = ($this->j14_vlrm2t == ""?@$GLOBALS["HTTP_POST_VARS"]["j14_vlrm2t"]:$this->j14_vlrm2t);
     }else{
       $this->j14_codigo = ($this->j14_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["j14_codigo"]:$this->j14_codigo);
     }
   }
 ...
 /* 
     if($this->j14_vlrm2t == null ){
       $this->j14_vlrm2t = 0;
     }
     */
     if($j14_codigo == "" || $j14_codigo == null ){
       $result = db_query("select nextval('ruas_j14_codigo_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: logradouro_j14_codigo_seq do campo: j14_codigo";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       }
       $this->j14_codigo = pg_result($result,0,0);
     }else{
       $result = db_query("select last_value from ruas_j14_codigo_seq");
       if(($result != false) && (pg_result($result,0,0) < $j14_codigo)){
         $this->erro_sql = " Campo j14_codigo maior que último número da sequencia.";
...
/*
   ...
   function alterar ($j14_codigo=null) {
     ...
     if(trim($this->j14_vlrm2t)!="" || isset($GLOBALS["HTTP_POST_VARS"]["j14_vlrm2t"])){
       $sql  .= $virgula." j14_vlrm2t = $this->j14_vlrm2t ";
       $virgula = ",";
     }
     $sql .= " where ";
     if($j14_codigo!=null){
